                ...
                <div className="flex flex-col justify-center items-center min-h-[500px] p-4">
                    ...
                    >
                        <p className="text-2xl my-4 md:w-4/5 md:text-3xl">
                            ...
                            founded in 2014 and has successfully built three
                            formula-style vehicles for the Formula SAE
                            competition. The diverse array of projects on our
                            team results in student collaboration among four
                            different schools at UT Dallas.
                        </p>
                        <p className="text-2xl my-4 md:w-4/5 md:text-3xl">
                            We are dedicated to imparting our enthusiasm for
                            engineering and math to aspiring individuals. We
                            volunteer at STEM fairs in the DFW area to encourage
                            new students to take similar paths. We leave a
                            lasting impression on future innovators by
