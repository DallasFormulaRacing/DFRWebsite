    ...
    <section className="mt-10 py-24 mx-8 min-h-screen md:mx-24">
      ...
      >
        ...
        <div className="col-span-3 md:col-span-2 row-span-1">
          ...
          <p className="indent-8 leading-10 w-11/12 md:w-4/5 text-3xl mt-8">
            Using Siemens StarCCM+, hundreds of configurations were analyzed and
            evaluated, allowing us to estimate the impact on on-track
            performance. This aero package was the catalyst for expanding the
            team's aerodynamics capabilities and, with continued development,
            increasing vehicle performance while allowing us to validate our
            simulation model and estimate on-track performance in many more
            dynamic conditions.
          </p>
        </div>
      </motion.div>
      ...
      >
        <div className="col-span-3 md:col-span-2 row-span-1">
          ...
          <p className="indent-8 w-11/12 text-3xl mt-8 md:w-4/5 leading-10">
            We talk to K-12 students at these events about the engineering
            needed to build our car and the unique experiences they can gain in
            higher education. Through this event, we aim to get them excited
