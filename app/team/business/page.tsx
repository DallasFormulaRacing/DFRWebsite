    ...
    community: [
        {
            ...
            name: "Preston Wolfe",
            role: "Social Media",
            quote: "Being a part of this team has introduced me to a whole new world of UT Dallas. Taking a part in the leadership has presented opportunities for myself to grow professionally in my field of user experience and learn more about the engineering field.",
        },
    ],
    outreach: [
        {
            ...
            quote: "This club is a perfect place to meet and forage new friends with similar passions and dedication to motorsport. I can not begin to list all the amazing and inspirational people I have met in and outside the team.",
        },
    ],
};
