    ...
    leadership: [
        {
            ...
            role: "F1 Tenth Lead",
            quote:
                "Building an automated car is not just about engineering; it's about pushing the boundaries of innovation and teamwork. As a leader of F1 Tenth, I have the privilege to guide a passionate group of individuals who are redefining the future of transportation with every line of code.",
        },
    ],
    sponsorship: [
        {
            ...
            role: "F1 Tenth Lead",
            quote:
                "Creating an automated car transcends mere engineering; it's about driving innovation and fostering collaboration. Leading F1 Tenth, I have the honor of steering a dedicated team that is revolutionizing the future of transportation, one line of code at a time.",
        },
    ],
};
