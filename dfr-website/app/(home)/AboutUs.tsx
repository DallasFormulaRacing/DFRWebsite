    ...
    return (
        <main className={"px-0 leading-7"}>
            <section className={"mt-10"}>
                <div
                    className={
                        "sm:grid sm:h-[500px] grid-cols-1 grid-rows-4 text-center"
                    }
                >
                    ...
                    <p
                        className={
                            "my-4 col-span-1 row-span-1 w-4/5 mx-auto text-2xl"
                        }
                    >
                    ...
                    <button
                        className={
                            "my-10 bg-accent-green text-wh-0 text-lg font-semibold w-40 h-12 rounded-md mt-8 col-span-1 row-span-1 mx-auto"
                        }
                    >
                        Learn More
                    </button>
